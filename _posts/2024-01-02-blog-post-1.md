...
on its two neighbors using simple multiplication operations, and “triangular self-attention updates” in which the update to a residue pair; that is around <span class="math inline"><em>i</em></span>:
...
followed by an equivalent update around <span class="math inline"><em>j</em></span> (i.e., <span class="math inline">Triangular Attention<sub><em>ij</em></sub></span>). <br>
<br>
<br>
