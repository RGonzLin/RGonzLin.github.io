...
followed by an equivalent update around <span class="math inline"><em>j</em></span> (that is, <span class="math inline">Triangular Attention<sub><em>ij</em></sub></span>). <br>
<br>
<br>
